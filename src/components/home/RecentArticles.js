...
function SuggestedArticles() {
  ...
  return (
    <div className="mx-[32px] sm:mx-[64px]">
      ...
      <div className="my-[16px] sm:my-[32px] flex border-black border-2 h-[48px] w-[75%] items-center px-3 ">
        
         <SearchIcon color='#000000'/>
          <input
            className="bg-transparent text-black mx-3 placeholder:text-black self-center w-[100vh]"
            type="text"
            color="#000000"
